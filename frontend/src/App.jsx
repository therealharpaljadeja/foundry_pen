...
const CodeBlock = ({ children }) => (
  <pre className="bg-[#1C1E24] text-white p-4 rounded-lg overflow-x-auto text-sm">
    <code>{children}</code>
  </pre>
);
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="lg:flex lg:space-x-8">
          <div className="lg:flex-grow">
            <h1 className="text-2xl sm:text-3xl font-bold mb-6">Evaluating Contract Storage with Foundry</h1>
            ...
            <section id="overview" className="mb-8">
              <h2 className="text-xl sm:text-2xl font-semibold mb-4 text-[#E06C75]">Overview</h2>
            ...
            <div className="space-y-8">
              <section id="init-project">
                <h2 className="text-lg sm:text-xl font-semibold mb-2 text-[#E06C75]">1. Initialize Your Foundry Project</h2>
              ...
              <section id="evaluate-storage">
                <h2 className="text-lg sm:text-xl font-semibold mb-2 text-[#E06C75]">2. Evaluate the Storage of the Contract</h2>
              ...
              <section id="deploy-contract">
                <h2 className="text-lg sm:text-xl font-semibold mb-2 text-[#E06C75]">3. Deploy the Counter Contract to Base Sepolia Testnet</h2>
              ...
              <section id="evaluate-deployed">
                <h2 className="text-lg sm:text-xl font-semibold mb-2 text-[#E06C75]">4. Evaluate the Storage of the Deployed Contract</h2>
              ...
              <section id="increment-counter">
                <h2 className="text-lg sm:text-xl font-semibold mb-2 text-[#E06C75]">5. Call the Counter Contract to Increment the Number</h2>
              ...
              <section id="evaluate-again">
                <h2 className="text-lg sm:text-xl font-semibold mb-2 text-[#E06C75]">6. Evaluate the Remote Contract's Storage Again</h2>
            ...
            <section id="further-resources" className="mt-8">
              <h2 className="text-lg sm:text-xl font-semibold mb-2 text-[#E06C75]">Further Resources</h2>
